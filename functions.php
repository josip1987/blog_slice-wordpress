<?php
  function ttb_styles() {
     ...
     wp_enqueue_style('baskerville', "https://fonts.googleapis.com/css?family=Libre+Baskerville:400,700");
    
  	 wp_enqueue_style('ttb_stylesheet', get_stylesheet_uri());


  	 wp_enqueue_script('jquery');                          //array/dependency => when jquery loads, load bootstrap // true => load on bottom
